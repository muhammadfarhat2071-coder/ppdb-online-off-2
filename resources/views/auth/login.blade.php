            ...
            <div class="col-md-5">
                <div class="login-container">
                    ...
                    <div class="login-header">
                        ...
                        <p class="mb-0">Sistem PPDB Online</p>
                    </div>
                    ...
                    <div class="login-body">
                        ...
                        <div class="demo-accounts">
                            <h6 class="text-center mb-3"><i class="fas fa-info-circle me-2"></i>Akun Demo</h6>
                            <div class="row">
                                <div class="col-12 mb-2">
                                    <small><strong>Admin:</strong> admin@smkbn666.sch.id | Password: password</small>
                                </div>
                                <div class="col-12">
                                    <small><strong>Siswa:</strong> siswa@email.com | Password: password</small>
                                </div>
                            </div>
                        </div>
                    </div>
